...
def run(args=None):
    ...
    # cerebro.addanalyzer(bt.analyzers.TradeAnalyzer,_name='trade_list')
    # cerebro.addanalyzer(bt.analyzers.Transactions,_name='trade_list')
    cerebro.addanalyzer(bt_trans_analyzer.transactions_analyzer,_name='position_list')
    # cerebro.addanalyzer(bt_logger_analyzer.logger_analyzer,_name='logger_writing')
...
def parse_args(pargs=None):
    ...
    parser.add_argument('--strat', required=False, default='', # backtest=False
                        metavar='kwargs', help='kwargs in k1=v1,k2=v2 format')
